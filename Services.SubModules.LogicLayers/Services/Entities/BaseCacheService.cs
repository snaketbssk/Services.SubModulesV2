namespace Services.SubModules.LogicLayers.Services.Entities
{
    public abstract class BaseCacheService : ICacheService, IDisposable
    {
        ...
        public abstract Task<bool> TryHashSetAsync<TKey, TValue>(string project, string container, IDictionary<TKey, TValue> values, CancellationToken cancellationToken = default);
        ...
        public abstract Task<(bool isSuccessful, IEnumerable<TValue> values, int totalCount)> TryPaginationGetAsync<TKey, TValue>(string project, string container, int numberPage, int sizePage, CancellationToken cancellationToken = default);
    }
}
