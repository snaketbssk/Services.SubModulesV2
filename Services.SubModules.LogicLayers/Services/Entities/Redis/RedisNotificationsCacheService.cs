...
{
    public class RedisNotificationsCacheService : BaseNotificationsCacheService
    {
        public RedisNotificationsCacheService(IConnectionMultiplexer connectionMultiplexer)
            : base()
        {
        }
    }
