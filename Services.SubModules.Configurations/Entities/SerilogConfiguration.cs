...
namespace Services.SubModules.Configurations.Entities
{
    ...
    public class SerilogConfiguration<T> : SingletonConfiguration<SerilogConfiguration<T>>
        where T : class, new()
    {
        /// <summary>
        /// Название файла конфигурации
        /// </summary>
        protected override string _nameFile => ConfigurationConstant.SERILOG_FILE;
